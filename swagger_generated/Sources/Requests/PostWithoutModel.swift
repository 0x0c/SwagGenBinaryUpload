...
extension TestAPI {
    ...
    Create a new user.
    */
    public enum PostWithoutModel {

        public static let service = APIService<Response>(id: "post-withoutModel", tag: "", method: "POST", path: "/withoutModel", hasBody: true, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: Body?, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: PostWithoutModel.service) { defaultEncoder in
