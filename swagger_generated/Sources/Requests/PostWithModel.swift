...
extension TestAPI {
    ...
    public enum PostWithModel {

        public static let service = APIService<Response>(id: "post-withModel", tag: "", method: "POST", path: "/withModel", hasBody: true, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: Body?, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: PostWithModel.service) { defaultEncoder in
